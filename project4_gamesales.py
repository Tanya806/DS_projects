...
#     
#     
# По графику выше хорошо выделяется:
#     
# * точка отсечения актуального периода
# 
# * перспективные платформы на прогноз 2017, туда можно включить PS4 \ XOne \ 3DS, они покроют нишу стационарных и портативных консолей, также можно включить ПК, который на протяжении всего исторического периода имеет не такие высокие продажи, но держит их уверенно и является лидером в своей нише
# 
# </div>
...
#     
#     После отсечения по дате получила новый перечень наиболее перспективных платформ - PS4, XOne, 3DS, PC  
# </div>
...
#     
#     
# Данные платформы действительно наиболее перспективные в своих нишах
# 
# </div>
...
# 
# - Корреляции между оценками пользователей и продажами нет. #NEW2
# 
...
# Европа:
#     
#     топ платформ: PS4, PS3, XOne #NEW2
...
# <div class="alert alert-info">
# <b>Общий вывод по итогам анализа данных: </b> 
#     
